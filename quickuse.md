...
`ochat` always knows the current date and time, and mentions it to the model
automatically on every turn — so it can correctly figure out what "tomorrow"
or "next Thursday" actually means, instead of guessing.
